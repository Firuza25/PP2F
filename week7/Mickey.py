...
def main():
    ...
    # loading the images 
    clock_image = pygame.transform.scale(pygame.image.load('/Users/firuza/Desktop/PP2/week7/images/mickeyclock (1).jpeg'), (800, 600))
    sechand_image = pygame.image.load('/Users/firuza/Desktop/PP2/week7/images/sechand-1.png')
    sechand_image = pygame.transform.scale(sechand_image, (250, 75))
    sechand_rect = sechand_image.get_rect()
    sechand_rect.center = (400, 300)
    minhand_image = pygame.image.load('/Users/firuza/Desktop/PP2/week7/images/minhand.png')
